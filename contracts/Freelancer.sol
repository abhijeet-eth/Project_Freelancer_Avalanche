// source: https://github.com/jacksonng77/GettingStartedEthereum/blob/main/freelancer.sol
...
contract Freelancer{
    ...
    function addSchedule(string memory _shortCode, string memory _description, uint256 _value) public 
    ...
    function fundTask(int256 _scheduleID) public payable
    ...
    function startTask(int256 _scheduleID) public
        inProjectState(ProjectState.accepted)
    ...
    function approveTask(int256 _scheduleID) public
        inProjectState(ProjectState.accepted)
    ...
    function releaseFunds(int256 _scheduleID) public
        payable
        inProjectState(ProjectState.accepted)
